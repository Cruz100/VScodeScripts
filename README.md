...
### DailyLabCleanup.ps1
Deletes Azure Resource Groups matching the naming convention `Lab-*`. Runs daily at 1:00 AM through an Azure Automation Account to remove abandoned lab resources and prevent unnecessary Azure costs.

### CreateLabsLoop.ps1
Creates multiple Azure lab environments in a loop. Prompts for lab names and deploys them in the East US region.
...
### CreateTicket.ps1
Automates ticket creation and reduces manual administrative work.
